    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-[501px] border border-white/30 rounded-cs-button bg-background p-8 shadow-lg">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-white text-3xl sm:text-[32px] font-bold mb-2">
            Forgot Password
          </h1>
        ...
        {error && (
          <div className="mb-6 p-3 bg-red-500/20 border border-red-500 text-red-300 rounded-lg text-sm">
            {error}
          </div>
        )}
        
        {message ? (
          <div className="mb-6 p-4 bg-green-500/20 border border-green-500 text-green-300 rounded-lg text-sm">
            {message}
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                value={email}
                onChange={(e) => setEmail(e.target.value)}
                className="w-full h-12 px-4 rounded-cs-button border border-white/20 bg-cs-blue text-black placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <button
              ...
              className="w-full h-12 bg-cs-blue-secondary text-black font-medium rounded-cs-button hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
